    ...
    const updateThumb = () => {
      ...
      animationFrame = requestAnimationFrame(() => {
        ...
        setSearchScrollThumb({
          ...
          right: Math.max(6, contentRect.right - scrollerRect.right + 6),
          height: thumbHeight,
        })
      })
    }
    ...
    <DialogPortal>
      ...
      >
        ...
        {searchScrollThumb && (
          <div
            aria-hidden="true"
            className="pointer-events-none absolute z-[80] w-[7px] rounded-full bg-foreground/70 shadow-[0_0_0_1px_hsl(var(--background)/0.7)]"
            style={{
