    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-5 shadow-sm">
          <Button variant="outline" className="w-full gap-2 bg-white text-gray-900 border-gray-300 hover:bg-gray-50" onClick={handleGoogleLogin} disabled={loading}>
          ...
          <Button variant="outline" className="w-full gap-2 bg-white text-gray-900 border-gray-300 hover:bg-gray-50" onClick={handleAppleLogin} disabled={loading}>
